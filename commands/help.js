...
module.exports = {
  name: "help",
  aliases: ["h"],
  description: ("24/7,join,disconnect,clip,clips
                help,invite,loop,lyrics,move
                np,pause,ping,play,playlist
                pruning,queue,remove,search
                suffle,skip,skipto,stop,uptime
                volume"),
  execute(message) {
